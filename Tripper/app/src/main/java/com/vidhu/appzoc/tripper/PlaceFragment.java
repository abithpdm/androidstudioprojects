...
public class PlaceFragment extends Fragment implements LocationListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View vPlace = inflater.inflate(R.layout.activity_place_fragment, container, false);
        ...
        mSprPlaceType = (Spinner) vPlace.findViewById(R.id.spr_place_type);
        ...
        btnFind = (Button) vPlace.findViewById(R.id.btn_find);
        ...
        if (status != ConnectionResult.SUCCESS) { // Google Play Services are not available
            ...
            mGoogleMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                ...
                public void onInfoWindowClick(Marker arg0) {
                    Intent intent = new Intent(getActivity().getApplicationContext(), PlaceDetailFragment.class);
